...
tap.test('Wire: Simple checks and coverage', async(l0) => {
    Wire();
    const v1 = wireFactory({config: {id: 'V', packet: {waitTime: 3000}}});
    ...
    l0.same(v1.ctx({b: 5}), {a: 6, b: 5}, 'should return {a: 6, b: 5}, overwrite only sec. value');
