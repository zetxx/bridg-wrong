    ...
    apiRequestReceived({message, meta}) {
        ...
        return new Promise(async(resolve, reject) => {
            ...
            try {
                ...
                this.log('debug', {in: 'base.apiRequestReceived', count: 2, text: 'api "in" method found', args: {message, meta, m, pack}});
                if (meta.isNotification) { // respond if notification, dont wait for anything to be executed
                    this.log('debug', {in: 'base.apiRequestReceived', count: 3, text: 'api "in" method found, but notification', args: {message, meta, m, pack}});
